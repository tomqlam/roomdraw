    ...
    return (
        <>
            ...
            <div className="buttons">
                <button
                    className={`button is-warning ${loading.frosh ? "is-loading" : ""}`}
                    style={{ marginBottom: "0.5rem" }}
                    onClick={() => postToFrosh(selectedRoomObject)}
                >
                    Add Frosh
                </button>
                <button
                    className={`button is-warning ${loading.preplace ? "is-loading" : ""}`}
                    style={{ marginBottom: "0.5rem" }}
                    onClick={() => preplaceOccupants(selectedRoomObject)}
                >
                    Pre-Place Occupants
                </button>
                <button
                    className={`button is-warning ${loading.removePreplace ? "is-loading" : ""}`}
                    style={{ marginBottom: "0.5rem" }}
                    onClick={() => removePreplaceOccupants(selectedRoomObject)}
                >
                    Remove Pre-Placed Occupants
                </button>
            </div>
